...
export const Default: StoryObj = {
  ...
  render: () => (
    <div
      ...
      style={{ fontFamily: "'Saans', ui-sans-serif, system-ui, sans-serif" }}
    >
      {/* Header */}
      ...
      {/* Cat canvas placeholder */}
      <div className="fixed inset-0 z-10 pointer-events-none flex items-center justify-center">
        <p className="font-mono text-xs text-stone-200 uppercase tracking-widest">
          Cat game canvas renders here
        </p>
      </div>
    </div>
  ),
